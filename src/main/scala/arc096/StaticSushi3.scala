...
object StaticSushi3 extends App {
  val N = MyPredef3.nextInt // 寿司の数
  val C = MyPredef3.nextLong // 外周
  val inputSushi :Array[Array[Long]] = Array.fill(N, 2)(MyPredef3.nextLong) // 距離, calの配列
